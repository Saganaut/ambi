...
const meta = {
  ...
  argTypes: {
    variant: { control: "inline-radio", options: ["full", "discovery", "compact"] },
  },
...
export const Draft: Story = {
  args: {
    variant: "full",
    deck: { ...mockDeck, publishStatus: "DRAFT", name: "Untitled deck (draft)" },
  },
};
...
export const WithActions: Story = {
  args: {
    variant: "full",
    actions: <Btn size="xs" fill="ghost">Edit</Btn>,
  },
};
