// The DS color picker (Figma 604-3249 / 603-2718), replacing the @uiw-based
// pickers. This file is the popover form: a trigger anchoring a
// FloatingPopover with a callout tail, containing ColorPickerPanel (which is
// also usable standalone — e.g. inside a modal or an existing popover).
//
// TODO: Rename to ColorPicker once the old @uiw-based components migrate off.
