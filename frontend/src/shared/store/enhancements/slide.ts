...
import type { CacheSyncMutationApi } from "./types";
...
Ambi.enhanceEndpoints({
  endpoints: {
    ...
    removeSlide: reconcilingSlideMutation<RemoveSlideApiArg, unknown>((draft, arg) => {
    ...
    setSlideCoverImage: reconcilingSlideMutation<SetSlideCoverImageApiArg, SlideResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
    ...
    clearSlideCoverImage: reconcilingSlideMutation<ClearSlideCoverImageApiArg, SlideResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
    ...
    setSlideBackgroundImage: reconcilingSlideMutation<SetSlideBackgroundImageApiArg, SlideResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
    ...
    clearSlideBackgroundImage: reconcilingSlideMutation<ClearSlideBackgroundImageApiArg, SlideResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
    ...
    setSlidePointSettings: reconcilingSlideMutation<SetSlidePointSettingsApiArg, PointSettingsResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
          slide.settings = {
            ...slide.settings,
      ...
      (draft, data) => {
        withSlide(draft, data.slideId, (slide) => {
          slide.settings = { ...slide.settings, pointSettings: data.pointSettings };
        });
      },
    ),
    clearSlidePointSettings: reconcilingSlideMutation<ClearSlidePointSettingsApiArg, PointSettingsResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
    ...
    setSlideAnswerSettings: reconcilingSlideMutation<SetSlideAnswerSettingsApiArg, AnswerSettingsResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
          slide.settings = {
            ...slide.settings,
      ...
      (draft, data) => {
        withSlide(draft, data.slideId, (slide) => {
          slide.settings = { ...slide.settings, answerSettings: data.answerSettings };
        });
      },
    ),
    clearSlideAnswerSettings: reconcilingSlideMutation<ClearSlideAnswerSettingsApiArg, AnswerSettingsResponse>(
      (draft, arg) => {
        withSlide(draft, arg.slideId, (slide) => {
