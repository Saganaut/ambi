import { PlaceOnImageQuestionView } from "@/features/deck/hooks/usePlaceOnImageEditor";
import { useState } from "react";
import { ItemId, SlideDraft } from "../_shared/Item.types";
import { useSlideDraft } from "../_shared/useSlideDraft";

export function usePlaceOnImageDraft({
  question,
}: {
  question?: PlaceOnImageQuestionView;
}): SlideDraft<"PLACE_ON_IMAGE"> {
