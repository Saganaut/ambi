...
const AuthenticatedDecksDeckIdViewRoute =
  AuthenticatedDecksDeckIdViewRouteImport.update({
    id: '/decks/$deckId/view',
    path: '/decks/$deckId/view',
    getParentRoute: () => AuthenticatedRoute,
  } as any)
const AuthenticatedDecksDeckIdPresentRoute =
  AuthenticatedDecksDeckIdPresentRouteImport.update({
    id: '/decks/$deckId/present',
    path: '/decks/$deckId/present',
    getParentRoute: () => AuthenticatedRoute,
  } as any)
const AuthenticatedDecksDeckIdEditRoute =
  AuthenticatedDecksDeckIdEditRouteImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/decks/$deckId/view': {
      id: '/_authenticated/decks/$deckId/view'
      path: '/decks/$deckId/view'
      fullPath: '/decks/$deckId/view'
      preLoaderRoute: typeof AuthenticatedDecksDeckIdViewRouteImport
      parentRoute: typeof AuthenticatedRoute
    }
    '/_authenticated/decks/$deckId/present': {
      id: '/_authenticated/decks/$deckId/present'
      path: '/decks/$deckId/present'
      fullPath: '/decks/$deckId/present'
      preLoaderRoute: typeof AuthenticatedDecksDeckIdPresentRouteImport
      parentRoute: typeof AuthenticatedRoute
    }
    '/_authenticated/decks/$deckId/edit': {
      id: '/_authenticated/decks/$deckId/edit'
      path: '/decks/$deckId/edit'
