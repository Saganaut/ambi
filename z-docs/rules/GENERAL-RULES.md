...
4.  **Docker Compose:** Always use `docker compose up -d` for infrastructure services (MongoDB, Redis). (we have a script ./scripts/ambi.sh we can use to start everything)
