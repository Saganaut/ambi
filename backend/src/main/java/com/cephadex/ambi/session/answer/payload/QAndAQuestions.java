 ...
 * this ordered list; the orchestrator appends a {@link Entry} (with a
 ...
 */
public record QAndAQuestions(List<Entry> questions) implements AnswerPayload {
     ...
     * round's questions across participants.
     */
    public record Entry(String id, String text, Instant askedAt) {
    }
